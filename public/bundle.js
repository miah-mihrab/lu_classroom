...
},{}],"alertMessage.js":[function(require,module,exports) {
"use strict";
...
var showAlert = function showAlert(type, message) {
  var div = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
...
exports.signInCredentials = signInCredentials;
...
function signInCredentials(_x, _x2) {
  return _signInCredentials.apply(this, arguments);
}

function _signInCredentials() {
  _signInCredentials = _asyncToGenerator(
  /*#__PURE__*/
...
},{"./alertMessage":"alertMessage.js"}],"deleteClassPost.js":[function(require,module,exports) {
"use strict";
...
function deleteClassPost(_x, _x2, _x3) {
  return _deleteClassPost.apply(this, arguments);
}

function _deleteClassPost() {
  _deleteClassPost = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(postId, classId, post) {
    var deleteResponse;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alertMessage.showAlert)("success", "Post deleted successfully");
            window.setTimeout(function () {
...
},{"./alertMessage":"alertMessage.js"}],"assignmentSubmission.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getStudentsAssignments = getStudentsAssignments;
...
//details
//file
function getStudentsAssignments(_x) {
  return _getStudentsAssignments.apply(this, arguments);
}

function _getStudentsAssignments() {
  _getStudentsAssignments = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(assignmentId) {
    var _response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: "GET",
              url: "/classwork/".concat(assignmentId)
            });
...
var _deleteClassPost = require("./deleteClassPost");

var _assignmentSubmission = require("./assignmentSubmission");

var signin = document.querySelector('.form--login'); // SIGNIN
...
if (editProfile) {
  editProfile.addEventListener('click', function (e) {
    e.preventDefault();
    var accountInfo = document.querySelectorAll('.form-control');
